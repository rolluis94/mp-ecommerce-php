<?php
	if (isset($_GET["preference_id"])) {
		...
		$estatus_pago = "";
		//https://rolluis94-mp-ecommerce-php.herokuapp.com/pay/aprovado.php?collection_id=9972547550&collection_status=approved&external_reference=null&payment_type=credit_card&merchant_order_id=1720547787&preference_id=617633181-0521a262-be46-4ba4-a79a-cde0f7cd0e13&site_id=MLM&processing_mode=aggregator&merchant_account_id=null
                    ...
                    <div class="as-accessories" id="as-accessories">
                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="min-height: 300px;">
                                    <div class="as-producttile-titlepricewraper" style="min-height: 300px;">
                                       
                                        <h3 >
                                            Tu pago esta <?php echo $estatus_pago; ?>
                                        </h3>
                                        <span><?php echo "collection_id: ".$collection_id; ?> , <?php echo "collection_status: ".$collection_status; ?>, <?php echo "external_reference: ".$external_reference; ?>, <?php echo "payment_type: ".$payment_type; ?>, <?php echo "preference_id: ".$preference_id; ?>
                                    </div>
